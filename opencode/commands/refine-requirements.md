...
Apply the policy from `AGENTS.md > Decomposition Policy`. If **any** trigger holds (more than 5 files, more than 2 architectural boundaries, introduces a new pattern, modifies a shared API consumed by more than 3 call sites), decompose into:

- `.github/requirements/requirements-index.md` — index file using the schema in `AGENTS.md`.
